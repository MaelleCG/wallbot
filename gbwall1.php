    ...
    <h1 class="titlepro">Nos Offres🤖</h1>
        <form action="index.php" method="POST" id="carform">
            ...
            <select class="selectrobot" name="carlist" form="carform">
                ...
                <option class="optionrobot" selected value="gbwall">GBWall</option>
            </select>
...
<div class="black3">
    <div class="columns"  id="colums">
        <div class="column">
            <div class="a1">Algorithme <br> <a href="gbwall.php" target="_blank"> En savoir plus</a></div>
            <div class="a2">Nouveaux Jeux <br> <a href="gbwall.php" target="_blank"> En savoir plus</a></div>
            <div class="a3">Code de la route<br> <a href="gbwall.php" target="_blank"> En savoir plus</a></div>
        </div>
        <div class="column"><img src="images/gifd.gif" width="30%"></div>
        <div class="column">
            <div class="a1">Internet <br><a href="gbwall.php" target="_blank"> En savoir plus</a> </div>
            <div class="a2">Actualités <br> <a href="gbwall.php" target="_blank"> En savoir plus</a></div>
            <div class="a3">Musique <br><a href="gbwall.php" target="_blank"> En savoir plus</a> </div>
        </div>
    </div>
    </div>
</section>
