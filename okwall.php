...
require_once('configuration/config.php');
    ...
    $requete='SELECT * FROM module WHERE collection_module_module=3';
...
<body>
    ...
    <!--page d'accueil-->
        ...
        <nav>
            ...
            <ul class="nav-links">
                <li><a href="bbwall1.php#produit">Le produit</a></li>
       ...
       <div class="info"> <h1>OKWall</h1>

        <p>Voici les différents modules disponibles pour le OKWall:</p>
